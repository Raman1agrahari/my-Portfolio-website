...
const Navbar = () => {
  ...
  return (
    <header className="w-full px-32 py-8 font-medium flex items-center z-10 justify-between dark:text-light relative lg:px-16 md:px-12 sm:px-8">
      <button
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        ...
        <nav className="flex items-center justify-center flex-wrap ">
          <motion.a
            href="https://www.linkedin.com/in/raman-agrahari/"
            target={"_blank"}
            whileHover={{ y: -2 }}
            className="w-6 mx-3"
            whileTap={{ scale: 0.9 }}
          ...
          <motion.a
            href="https://github.com/Raman1agrahari"
            target={"_blank"}
            whileHover={{ y: -2 }}
            className="w-6 mx-3"
            whileTap={{ scale: 0.9 }}
          ...
          <motion.a
            href="https://x.com/RamanAgrah13770?t=XEwIEL5xmGZrxbKf8b0SnA&s=08"
            target={"_blank"}
            whileHover={{ y: -2 }}
            className="w-6 mx-3"
            whileTap={{ scale: 0.9 }}
